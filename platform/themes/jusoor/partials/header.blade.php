...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Markazi+Text:wght@400;500;600;700&display=swap"
          rel="stylesheet">
    <link href="https://www.fontstatic.com/f=jazeera,jazeera-light"
          rel="stylesheet">
    ...
    {{--<link rel="stylesheet" type="text/css" href="/themes/jusoor/css/magnific-popup.css" media="screen">--}}
    ...
    {{--<link rel="stylesheet" type="text/css" href="/themes/jusoor/css/ekko-lightbox.css" media="screen">--}}
    ...
    <link rel="stylesheet" type="text/css"
          href="/themes/jusoor/css/nedaa-style.css?v=<?php $date = new \DateTime('now');
          echo $date->format('d.G.i'); ?>" media="screen">
    <link rel="stylesheet" type="text/css"
          href="/themes/jusoor/css/new-jusoor.css?v=1.<?php $date = new \DateTime('now');
          echo $date->format('d.G.i'); ?>" media="screen">
            ...
            <div class="logo-advertisement ">
                <div class="container row">
                    ...
                    <div class="col-3 navbar-header">
                        <a class="navbar-brand desktop" href="/"><img width="120"
...
<div><a class="podcast">{{__('بودكاست')}} <i class="	fa fa-play-circle-o"></i></a><div>
                            <!-- /.navbar-collapse -->
                        </div>
                    </div>
